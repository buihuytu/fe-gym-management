  ...
  onHeaderButtonClick(e: EnumBaseButton) {
    ...
    switch (e) {
      ...
      case EnumBaseButton.EDIT:
        if (this.selectedIds.length === 0) return this.alertService.error('Have not selected any records');
        if (this.selectedIds.length > 1) return this.alertService.warn('Only select 1 record to make editing');
        this.router.navigate(
      ...
      case EnumBaseButton.ACTIVATE:
        ...
        this.dialogService.body$.next("Are you sure you want to apply the selected objects?");
      ...
      case EnumBaseButton.INACTIVATE:
        ...
        this.dialogService.showConfirmDialog$.next(true);
        this.dialogService.title$.next("CONFIRM");
        this.dialogService.body$.next("Are you sure you want to stop applying the selected objects?");
        this.dialogService.okButtonText$.next("Agree");
        this.dialogService.cancelButtonText$.next("Back");
        break;
      case EnumBaseButton.DELETE:
        ...
        this.dialogService.showConfirmDialog$.next(true);
        this.dialogService.title$.next("CONFIRM");
        this.dialogService.body$.next("Are you sure you want to delete the selected objects?");
        this.dialogService.okButtonText$.next("Agree");
        this.dialogService.cancelButtonText$.next("Back");
        break;
      case EnumBaseButton.APPROVE:
        ...
        this.dialogService.showConfirmDialog$.next(true);
        this.dialogService.title$.next("CONFIRM");
        this.dialogService.body$.next("Are you sure you want to approve the selected objects?");
        this.dialogService.okButtonText$.next("Agree");
        this.dialogService.cancelButtonText$.next("Back");
        break;
      case EnumBaseButton.EXCEL:
        const urlExcel = this.apiDefinition.exportExcel;
        if (!urlExcel) return this.alertService.warn('Cannot found API');;
        this.subscriptions.push(
      ...
      case EnumBaseButton.PDF:
        ...
        if (!urlPdf) return this.alertService.warn('Cannot found API');;
        this.subscriptions.push(
